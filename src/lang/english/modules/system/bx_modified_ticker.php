...
define('BX_TICKER_TYPE_TITLE', 'Type');
define('BX_TICKER_TYPE_DESC', 'standard (rendered automatically) or smarty (only assigns the {$bx_ticker} template variable, no automatic output).');
